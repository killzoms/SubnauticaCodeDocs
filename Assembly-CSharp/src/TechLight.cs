    ...
    public class TechLight : MonoBehaviour, IConstructable, IObstacle
    {
        ...
        public void OnConstructedChanged(bool constructed)
        {
            if (constructed)
            {
                ...
                {
                    GetComponent<LargeWorldEntity>().cellLevel = LargeWorldEntity.CellLevel.Medium;
                }
            }
            else
            {
        ...
        {
            ProfilingUtils.BeginSample("TechLight.GetNearestValidRelay");
        ...
        {
            ProfilingUtils.BeginSample("TechLight.FindNearestValidRelay");
