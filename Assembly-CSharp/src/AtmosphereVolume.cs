...
namespace AssemblyCSharp
{
    ...
    public class AtmosphereVolume : MonoBehaviour, IDeserialized, ICompileTimeCheckable
    {
        ...
        [ProtoMember(2)]
        public Color fogColor = new Color(0f, 44f / 85f, 172f / 255f);
        ...
        private void UpgradeData()
        {
            if (version < 2)
            {
                ...
                fog.dayNightColor = global::UWE.Utils.DayNightGradient(fogColor);
        ...
        public bool Contains(Vector3 pos)
        {
            ...
            {
                return global::UWE.Utils.IsInsideCollider((BoxCollider)component, pos);
            }
            if (component is SphereCollider)
            {
                return global::UWE.Utils.IsInsideCollider((SphereCollider)component, pos);
            }
            if (component is CapsuleCollider)
            {
                return global::UWE.Utils.IsInsideCollider((CapsuleCollider)component, pos);
            }
            return false;
        }
        ...
        private void Start()
        {
            if (affectsVisuals)
            {
                ...
                InvokeRepeating("CheckTriggerExit", global::UnityEngine.Random.value, 10f);
            }
