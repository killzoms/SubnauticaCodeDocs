...
namespace AssemblyCSharp
{
    ...
    public class Flare : PlayerTool
    {
        ...
        private float dropForceAmount = 300f;
        ...
        private void UpdateLight()
        {
            ...
            if (num > 0.1f)
            {
                ...
                {
                    float t = num * 3f - 0.1f;
                    light.intensity = Mathf.Lerp(0f, num4, t);
                    light.range = Mathf.Lerp(0f, num5, t);
                }
                else
                {
        ...
        private void Update()
        {
            ...
            {
                loopingSound.Stop();
                global::UnityEngine.Object.Destroy(base.gameObject, 2f);
            }
        }
        ...
        private void OnDrop()
        {
            GetComponent<Rigidbody>().AddForce(MainCamera.camera.transform.forward * dropForceAmount);
            GetComponent<Rigidbody>().AddTorque(base.transform.right * dropTorqueAmount);
            if ((bool)fxControl && !fxIsPlaying)
            {
                fxControl.Play(1);
            }
