        ...
        public void OnHandHover(GUIHand hand)
        {
            if (base.gameObject.GetComponent<Constructable>().constructed)
            {
                HandReticle.main.SetInteractText(
                    Language.main.GetFormat("AccumulatorStatus", Mathf.RoundToInt(storePowerInterface.GetPower()),
                        Mathf.RoundToInt(storePowerInterface.GetMaxPower())), translate: false);
