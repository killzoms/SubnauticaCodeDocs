...
namespace AssemblyCSharp
{
    public class PowerRelay : MonoBehaviour, IPowerInterface
    {
        ...
        {
            InvokeRepeating("UpdatePowerState", global::UnityEngine.Random.value, 0.5f);
            InvokeRepeating("MonitorCurrentConnection", global::UnityEngine.Random.value, 1f);
            lastCanConnect = CanMakeConnection();
            StartCoroutine(UpdateConnectionAsync());
            constructable = GetComponent<Constructable>();
            RegisterRelay(this);
            GameObject original = Resources.Load<GameObject>("Base/Ghosts/PowerSystemPreview");
            powerPreview = global::UnityEngine.Object.Instantiate(original, Vector3.zero, Quaternion.identity);
        ...
        {
            ProfilingUtils.BeginSample("PowerRelay.FindNearestValidRelay");
            PowerRelay closestRelay = null;
            float closestDistSq = maxOutboundDistance * maxOutboundDistance;
        ...
        {
            ProfilingUtils.BeginSample("PowerRelay.IsValidRelayForConnection");
            try
            {
        ...
        {
            ProfilingUtils.BeginSample("PowerRelay.CheckRelayForValidCloserConnection");
