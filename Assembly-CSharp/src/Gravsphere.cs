    ...
    public class Gravsphere : DropTool
    {
        ...
        public struct GravPad
        {
            ...
            public void DestroyMats()
            {
                for (int i = 0; i < vfxHaloRenderer.materials.Length; i++)
                {
                    global::UnityEngine.Object.Destroy(vfxHaloRenderer.materials[i]);
                }
            }
        }
        ...
        {
            ProfilingUtils.BeginSample("Gravsphere.GetIsValidTarget");
            bool result = false;
        ...
        {
            Rigidbody componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<Rigidbody>(collider.gameObject);
        ...
        {
            ProfilingUtils.BeginSample("Gravsphere.ApplyGravitation");
        ...
        {
            ProfilingUtils.BeginSample("Gravsphere.CleanAttractablesAndFX");
        ...
        {
            GameObject obj = global::UnityEngine.Object.Instantiate(vfxPrefab, Vector3.zero, Quaternion.identity);
        ...
        private void DestroyEffect(int index)
        {
            ...
            {
                global::UnityEngine.Object.Destroy(vFXElectricLine.gameObject);
            }
        }

        private void UpdateEffectPositions()
        {
            ProfilingUtils.BeginSample("Gravsphere.UpdateEffectPositions");
