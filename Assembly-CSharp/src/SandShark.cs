...
namespace AssemblyCSharp
{
    ...
    public class SandShark : Creature
    {
        ...
        private bool FindLeashPosition()
        {
            ...
            if (global::UWE.Utils.TraceForTerrain(new Ray(origin, Vector3.down), 3000f, out var hitInfo))
            {
        ...
        {
            ProfilingUtils.BeginSample("SandShark.UpdateFindLeashPosition");
        ...
        public void Update()
        {
            ProfilingUtils.BeginSample("InGround");
            ...
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("ModelOffset");
            float num = 0f;
            ...
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("DigEffect");
            ...
            if (wasOnGround != onSurface)
            {
                ...
                GameObject obj = global::UWE.Utils.InstantiateWrap(gameObject);
            ...
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("GroundMoveTrail");
