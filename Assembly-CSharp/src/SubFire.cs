    ...
    public class SubFire : MonoBehaviour, IOnTakeDamage
    {
        ...
        private void Start()
        {
            ...
            if (fireCount > 0)
            {
                ...
                {
                    CyclopsRooms key = (CyclopsRooms)global::UnityEngine.Random.Range(0, max);
        ...
        private void Update()
        {
            ...
            {
                if (cyclopsExternalCams.GetUsingCameras())
                {
                    smokeController.intensity = 0f;
                    smokeImpostorRenderer.enabled = true;
                }
        ...
        private void EngineOverheatSimulation()
        {
            ...
            if (cyclopsMotorMode.cyclopsMotorMode == CyclopsMotorMode.CyclopsMotorModes.Flank && subControl.appliedThrottle && cyclopsMotorMode.engineOn)
            {
                ...
                {
                    num = global::UnityEngine.Random.Range(1, 4);
                ...
                {
                    num = global::UnityEngine.Random.Range(1, 6);
        ...
        public void CreateFire(RoomFire startInRoom)
        {
            ...
            int index = global::UnityEngine.Random.Range(0, availableNodes.Count);
            Transform obj = availableNodes[index];
            startInRoom.fireValue++;
            PrefabSpawn component = obj.GetComponent<PrefabSpawn>();
            if (!(component == null))
            {
                Fire componentInChildren = component.SpawnManual().GetComponentInChildren<Fire>();
        ...
        private bool CreateFireChance(float chance)
        {
            ...
            if (global::UnityEngine.Random.Range(0f, max) <= chance)
            {
                return true;
            }
            return false;
        ...
        {
            global::UnityEngine.Object.Destroy(smokeImpostorRenderer.material);
        }
    }
}
