...
namespace AssemblyCSharp
{
    ...
    public class Terraformer : PlayerTool
    {
        ...
        public override void OnHolster()
        {
            ...
            {
                global::UnityEngine.Object.Destroy(activeStroke);
            }
            activeStrokes.Clear();
            global::UnityEngine.Object.Destroy(probe);
        }
        ...
        private void PrepareProbe()
        {
            if (probe == null)
            {
                ...
                global::UnityEngine.Object.Destroy(probe.GetComponent<Collider>());
            }
        }
        ...
        public void Update()
        {
            ...
            if (penDown && !usingPlayer.GetRightHandHeld() && !usingPlayer.GetLeftHandHeld())
            {
                _ = Vector3.zero;
                foreach (GameObject activeStroke in activeStrokes)
                {
                    Utils.PlayOneShotPS("VFX/xTerraform", activeStroke.transform.position, Quaternion.Euler(new Vector3(270f, 0f, 0f)), null, editRadius);
            ...
            bool flag2 = Input.GetKey(KeyCode.LeftShift) || usingPlayer.GetLeftHandDown();
            if (flag2 != isDig)
            {
                isDig = flag2;
            ...
            if (usingPlayer.GetRightHandDown() || usingPlayer.GetLeftHandDown())
            {
                if (!flag)
                {
