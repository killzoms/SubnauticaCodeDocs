...
namespace AssemblyCSharp
{
    ...
    public class VFXVehicleDamages : MonoBehaviour, IOnTakeDamage
    {
        ...
        public class OverlayHelper
        {
            ...
            public void Init()
            {
                matInstance = global::UnityEngine.Object.Instantiate(material);
            ...
            public void UpdateMaterial()
            {
                ...
                else if (isFadingOut)
                {
                    ...
                    {
                        ps.Stop();
                        global::UnityEngine.Object.Destroy(ps.gameObject, 2f);
                    }
                }
                else
                {
        ...
        private void Update()
        {
            ProfilingUtils.BeginSample("VFXVehicleDamage.Update()");
            for (int i = 0; i < overlays.Length; i++)
            {
