...
{
    [ProtoContract]
    public class EscapePod : MonoBehaviour, IProtoEventListener, IProtoTreeEventListener
    {
        ...
        [AssertNotNull]
        public PrefabSpawn vfxSpawner;

        [AssertNotNull]
        public PrefabSpawn radioSpawner;

        [AssertNotNull]
        public PrefabSpawn birdsSpawner;
        ...
        public PrefabSpawn[] moduleSpawners;
        ...
        public void OnProtoDeserialize(ProtobufSerializer serializer)
        {
            if (version < 2)
            {
                ...
                StorageHelper.RestoreItems(serializer, serializedStorage, storageContainer.container);
                version = 2;
            }
            if (version < 3)
            {
        ...
        public void StorageHover()
        {
            ...
            handReticle.SetInteractText("EscapePodStorageOpen");
        ...
        private void StorageOnFlapOpened()
        {
            ...
            if (!pDA.Open(PDATab.Inventory, storagePivot, StorageOnClosePDA, 4f))
            {
        ...
        {
            HandReticle handReticle = HandReticle.main;
            handReticle.SetInteractText(medKitOpen ? "EscapePodMedKitClose" : "EscapePodMedKitOpen");
            handReticle.SetIcon(HandReticle.IconType.Hand);
        }
