...
namespace AssemblyCSharp
{
    public class Bed : CinematicModeTrigger
    {
        ...
        private float kSleepGameTimeDuration = 396.000031f;
        ...
        private void SwitchBedUsingEffects(Player player, bool switchOn)
        {
        ...
        private void EnterInUseMode(Player player)
        {
            ...
            {
                SwitchBedUsingEffects(player, switchOn: true);
        ...
        private void ExitInUseMode(Player player, bool skipCinematics = false)
        {
            ...
            SwitchBedUsingEffects(player, switchOn: false);
