        ...
        private void Construct()
        {
            ...
            for (int j = 0; j < renderers.Length; j++)
            {
                ...
                for (int k = 0; k < materials.Length; k++)
                {
                    ...
                    if (materials[k].shader == marmoUberShader && materials[k].shader != null)
                    {
                    ...
                    {
                        if (materials[k].shader == transparentShaders[l])
                        {
                            flag = true;
                            break;
                        }
                ...
                for (int i = 0; i < renderers.Length; i++)
                {
                    ...
                    for (int j = 0; j < renderers[i].materials.Length; j++)
                    {
                        if (i < originalMaterials.Length && j < originalMaterials[i].Length && !(originalMaterials[i][j] == null) && !(renderers[i].materials[j] == null))
                        {
                            ...
                            global::UnityEngine.Object.Destroy(originalMaterials[i][j]);
                        }
                    }
                }
            }
