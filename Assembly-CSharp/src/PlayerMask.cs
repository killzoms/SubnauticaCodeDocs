...
namespace AssemblyCSharp
{
    public class PlayerMask : MonoBehaviour
    {
        ...
        public float referenceAspect = 1.77777779f;
        ...
        {
            Camera mainCamera = SNCameraRoot.main.mainCamera;
            if (mainCamera.fieldOfView != currentFov || mainCamera.aspect != currentAspect)
            {
                GetViewSpaceAnchors(mainCamera.fieldOfView, mainCamera.aspect, out var topLeftAnchor, out var topMiddleAnchor, out var topRightAnchor, out var bottomLeftAnchor, out var bottomMiddleAnchor, out var bottomRightAnchor);
                ...
                currentAspect = mainCamera.aspect;
            }
        }
    }
}
