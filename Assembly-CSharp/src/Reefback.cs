...
namespace AssemblyCSharp
{
    ...
    public class Reefback : Creature
    {
        ...
        private void SetBurrowPos()
        {
            ...
            do
            {
                float num2 = (float)((double)(global::UnityEngine.Random.value * 2f) * Math.PI);
                float num3 = global::UnityEngine.Random.Range(75, 150);
                Vector3 vector = new Vector3(base.transform.position.x + (float)Math.Cos(num2) * num3, base.transform.position.y + 500f, base.transform.position.z + (float)Math.Sin(num2) * num3);
        ...
        {
            base.gameObject.GetComponent<Rigidbody>().isKinematic = mode == Mode.Burrowing || mode == Mode.Unburrowing || mode == Mode.Burrowed;
