        ...
        private void LateUpdate()
        {
            if (makesRings.value)
            {
                ...
                if (delayTimer < 0f)
                {
                    ...
                    elecLight.transform.position = ringElecLine.elecPoints[Random.Range(0, ringElecLine.elecPoints.Length)].position;
                }
            }
            else
            {
                elecLight.transform.position = elecPoints[Random.Range(0, elecPoints.Length)].position;
            }
        }
