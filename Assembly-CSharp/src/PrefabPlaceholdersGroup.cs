...
namespace AssemblyCSharp
{
    ...
    public class PrefabPlaceholdersGroup : MonoBehaviour, IProtoTreeEventListener, ICompileTimeCheckable, ICompileTimeSetupable
    {
        ...
        private void Start()
        {
            if (!isInitialized)
            {
                Spawn(immediate: false, preview: false);
                isInitialized = true;
            }
        }
        ...
        public void Spawn(bool immediate, bool preview)
        {
            for (int i = 0; i < prefabPlaceholders.Length; i++)
            {
                ...
                {
                    prefabPlaceholder.Spawn(immediate, preview);
                }
            }
        }
        ...
        public string CompileTimeSetup()
        {
            ...
            foreach (int item in hashSet)
            {
                ...
                global::UnityEngine.Object.DestroyImmediate(componentsInChildren[item].gameObject, allowDestroyingAssets: true);
            }
