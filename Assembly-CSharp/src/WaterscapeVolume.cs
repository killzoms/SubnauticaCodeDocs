    ...
    public class WaterscapeVolume : MonoBehaviour
    {
        ...
        private void SetupWaterPlane(Camera camera, GameObject waterPlane)
        {
            if (waterPlane != null)
            {
                ...
                global::UnityEngine.Plane plane = new global::UnityEngine.Plane(transform.up, transform.position);
                global::UnityEngine.Plane plane2 = worldToCameraMatrix.TransformPlane(plane);
