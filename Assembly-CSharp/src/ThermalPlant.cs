...
namespace AssemblyCSharp
{
    ...
    public class ThermalPlant : HandTarget, IHandTarget
    {
        ...
        private void Start()
        {
            InvokeRepeating("QueryTemperature", global::UnityEngine.Random.value, 10f);
            InvokeRepeating("AddPower", global::UnityEngine.Random.value, 2f);
        ...
        public void UpdateUI()
        {
            ...
            Color color = ((!(num < 0.3f)) ? global::UWE.Utils.LerpColor(Color.yellow, Color.green, (num - 0.4f) / 0.6f) : global::UWE.Utils.LerpColor(Color.red, Color.yellow, num / 0.4f));
        ...
        public void OnHandHover(GUIHand hand)
        {
            ...
            {
                HandReticle.main.SetInteractText(Language.main.GetFormat("ThermalPlantStatus", Mathf.RoundToInt(powerSource.GetPower()), Mathf.RoundToInt(powerSource.GetMaxPower())), translate: false);
