...
namespace AssemblyCSharp
{
    public class Projectile : MonoBehaviour
    {
        ...
        {
            GetComponent<Rigidbody>().velocity = Vector3.Normalize(direction) * speed;
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            {
                GetComponent<Rigidbody>().velocity = Vector3.Normalize(-collision.relativeVelocity) * speed * 0.8f;
                return;
            }
            LiveMixin componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<LiveMixin>(gameObject);
