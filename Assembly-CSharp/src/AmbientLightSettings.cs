...
namespace AssemblyCSharp
{
    ...
    public class AmbientLightSettings : ISerializationCallbackReceiver
    {
        ...
        public static readonly Color defaultColor = new Color(52f / 255f, 52f / 255f, 52f / 255f);
        ...
        private void UpgradeData()
        {
            if (version < 2)
            {
                dayNightColor = global::UWE.Utils.DayNightGradient(color);
                version = 2;
            }
        }
        ...
        public void CopyFrom(AmbientLightSettings other)
        {
            ...
            scale = other.scale;
            dayNightColor = global::UWE.Utils.Clone(other.dayNightColor);
        }
