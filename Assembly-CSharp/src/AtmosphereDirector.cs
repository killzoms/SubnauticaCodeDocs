...
namespace AssemblyCSharp
{
    public class AtmosphereDirector : MonoBehaviour
    {
        ...
        {
            ProfilingUtils.BeginSample("AtmosphereDirector.AddVolume");
            try
            {
        ...
        {
            ProfilingUtils.BeginSample("AtmosphereDirector.RemoveVolume");
        ...
        private void Start()
        {
            ...
            if (num < array.Length)
            {
                WaterscapeVolume waterscapeVolume = (waterVolume = array[num]);
            }
            ...
            defaultSettings.amb.dayNightColor = global::UWE.Utils.DayNightGradient(RenderSettings.ambientLight);
