    ...
    public class ReefbackLife : MonoBehaviour, IProtoTreeEventListener, GameObjectPool.IPooledObject
    {
        ...
        private IEnumerator Initialize()
        {
            ...
            if (hasCorals)
            {
                ...
                {
                    grassIndex = global::UnityEngine.Random.Range(1, grassVariants.Length);
                }
            }
        }
        ...
        private IEnumerator SpawnPlants()
        {
            ...
            for (int i = 0; i < plantSlots.Length; i++)
            {
                ...
                float num2 = global::UnityEngine.Random.value * sumProb;
                float num3 = 0f;
                int num4 = 0;
                ...
                GameObject obj = global::UWE.Utils.InstantiateWrap(reefbackSlotPlant.prefabVariants.GetRandom(), transform.position, Quaternion.Euler(reefbackSlotPlant.startRotation));
        ...
        private IEnumerator SpawnCreatures()
        {
            ...
            for (int j = 0; j < creatureSlots.Length; j++)
            {
                ...
                float num3 = global::UnityEngine.Random.value * sumProb;
                float num4 = 0f;
                int num5 = 0;
                ...
                int num = global::UnityEngine.Random.Range(reefbackSlotCreature.minNumber, reefbackSlotCreature.maxNumber + 1);
                for (int i = 0; i < num; i++)
                {
                    Vector3 position = creatureSlot.localPosition + global::UnityEngine.Random.insideUnitSphere * 5f;
                    Quaternion localRotation = creatureSlot.localRotation;
                    GameObject obj = global::UnityEngine.Object.Instantiate(prefabToSpawn, position, localRotation);
