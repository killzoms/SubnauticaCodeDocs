...
namespace AssemblyCSharp
{
    ...
    public class Charger : MonoBehaviour, IProtoEventListener, IConstructable, IObstacle
    {
        ...
        protected const float terminationDistance = 4f;
        ...
        private void Update()
        {
            ...
            if (player != null && (player.transform.position - base.transform.position).sqrMagnitude >= 16f)
            {
                player = null;
                if (!HasChargables())
                {
        ...
        public void OnHandHover(HandTargetEventData eventData)
        {
            if (base.enabled)
            {
                ...
                main.SetInteractText(labelInteract);
            }
        }
        ...
        protected void OpenPDA()
        {
            ...
            if (!pDA.isInUse)
            {
                ...
                pDA.Open(PDATab.Inventory, base.transform, null, 4f);
            }
        }
