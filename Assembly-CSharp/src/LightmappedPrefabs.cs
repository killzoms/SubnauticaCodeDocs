...
namespace AssemblyCSharp
{
    public class LightmappedPrefabs : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            uGUI.main.loading.Begin(withoutFadeIn: true);
        ...
        private IEnumerator LoadPrefabSceneCoroutine(string scene)
        {
            ...
            else if (op == null)
            {
                ...
                WaitScreen.AsyncOperationItem waitItem = WaitScreen.Add(Language.main.GetFormat("LoadingSceneFormat", Language.main.Get(scene)), op);
                yield return op;
        ...
        private void Update()
        {
            ProfilingUtils.BeginSample("LightmappedPrefab.Update()");
