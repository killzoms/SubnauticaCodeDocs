...
namespace AssemblyCSharp
{
    public class uGUI_Equipment : MonoBehaviour, uGUI_INavigableIconGrid
    {
        ...
        {
            EquipmentType equipmentType = CraftData.GetEquipmentType(p.GetTechType());
        ...
        public string GetTooltip(uGUI_EquipmentSlot instance)
        {
            if (slots.TryGetValue(instance, out var value))
            {
                return inventory.GetTooltip(value);
            }
            return null;
        }
        ...
        public ItemAction CanSwitchOrSwap(string slotB)
        {
            ...
            if (!Equipment.IsCompatible(CraftData.GetEquipmentType(item.GetTechType()), Equipment.GetSlotType(slotB)))
            {
                return ItemAction.None;
            }
        ...
        public void SelectItem(object item)
        {
            ...
            if (item != null)
            {
                ...
                if (!(uGUI_EquipmentSlot2 == null) && slots.TryGetValue(uGUI_EquipmentSlot2, out var _))
                {
                    ...
                    uGUI_Tooltip.Set(uGUI_EquipmentSlot2);
                }
            }
        }
