...
namespace AssemblyCSharp
{
    public class DirectionIndicator : MonoBehaviour
    {
        ...
        private void Update()
        {
            ProfilingUtils.BeginSample("DirectionIndicator.Update()");
            if (_goal != null && _goal.showDirection)
            {
                ...
                if (zero != Vector3.zero)
                {
                    ...
                    Vector3 euler = new Vector3(global::UWE.Utils.GetPitchDegFromVector(v), global::UWE.Utils.GetYawDegFromVector(v), 0f);
