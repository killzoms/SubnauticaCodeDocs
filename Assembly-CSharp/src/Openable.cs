    ...
    public class Openable : HandTarget, IHandTarget
    {
        ...
        public void OnHandHover(GUIHand hand)
        {
            ...
            if (!IsSealed())
            {
                if (isLocked)
                {
                    HandReticle.main.SetInteractInfo("Locked");
                }
                else
                {
                    HandReticle.main.SetInteractText(isOpen ? "Close" : "Open");
                }
            }
            else
            {
                HandReticle.main.SetInteractInfo("Sealed", "SealedInstructions");
            }
        }
        ...
        {
            if ((bool)collider.GetComponent<Player>())
            {
                blocked = true;
            }
        }
