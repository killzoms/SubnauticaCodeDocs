...
namespace AssemblyCSharp
{
    ...
    public class SeaTreader : Creature
    {
        ...
        public void Update()
        {
            ...
            myRigidbody.isKinematic = cinematicMode || grazingAnimation || turningAnimation;
            float b = 0f;
        ...
        private void UpdateTurning(out bool turningAnimation)
        {
            ...
            base.transform.rotation = Quaternion.Lerp(base.transform.rotation, b, Time.deltaTime * 0.1f);
            float num = 0f;
            ...
            SafeAnimator.SetBool(GetAnimator(), "turning", turningAnimation);
            if (turningAnimation)
            {
        ...
        private void UpdatePath(out bool grazingAnimation)
        {
            ...
            if (grazing)
            {
                ...
                SafeAnimator.SetBool(GetAnimator(), "grazing", grazingAnimation);
                myRigidbody.isKinematic = grazingAnimation;
            }
        ...
        {
            SafeAnimator.SetBool(GetAnimator(), "grazing", value: false);
            SafeAnimator.SetBool(GetAnimator(), "turning", value: false);
            SafeAnimator.SetBool(GetAnimator(), "pooping", value: false);
