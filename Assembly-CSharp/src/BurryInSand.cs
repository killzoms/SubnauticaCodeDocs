...
namespace AssemblyCSharp
{
    ...
    public class BurryInSand : CreatureAction
    {
        ...
        {
            ProfilingUtils.BeginSample("CreatureAction::Perform (BurryInSand)");
            if (!burried)
            {
                if (!foundPosition)
                {
                ...
                if (foundPosition)
                {
                    ...
                    else if (sqrMagnitude <= burryDistanceSq)
                    {
                    ...
                    else
                    {
                        ...
                        {
                            Debug.DrawLine(base.transform.position, burryPosition, Color.yellow);
                        }
