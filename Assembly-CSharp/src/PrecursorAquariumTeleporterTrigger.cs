...
namespace AssemblyCSharp
{
    public class PrecursorAquariumTeleporterTrigger : MonoBehaviour, IStoryGoalListener
    {
        ...
        private void Start()
        {
            ...
            if (main.IsGoalComplete(listenForIncubatorActiveGoal))
            {
                OnIncubatorActive();
            }
        ...
        {
            InvokeRepeating("CheckRange", global::UnityEngine.Random.value, 1f);
        }
        ...
        private void OnTeleporterUncover()
        {
            ...
            SafeAnimator.SetBool(targetAnimator, atTeleporterParameterName, global::UWE.Utils.IsInsideCollider(trigger, pos));
