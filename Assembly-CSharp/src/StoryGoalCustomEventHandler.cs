    ...
    public class StoryGoalCustomEventHandler : MonoBehaviour, ICompileTimeCheckable
    {
        ...
        public void NotifyGoalComplete(string key)
        {
            ...
            else if (string.Equals(key, "SunbeamCheckPlayerRange", StringComparison.OrdinalIgnoreCase))
            {
                ...
                (IsPlayerAtLandingSite() ? sunbeamDestroyEventInRange : sunbeamDestroyEventOutOfRange).Trigger();
            }
        ...
        {
            string text = int.Parse((string)n.data[0]) switch
            {
                1 => "Infection_Progress1", 
                2 => "Infection_Progress2", 
                3 => "Infection_Progress3", 
                4 => "Infection_Progress4", 
                _ => "Infection_Progress5", 
            };
