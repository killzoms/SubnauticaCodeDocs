...
namespace AssemblyCSharp
{
    public class VFXController : MonoBehaviour
    {
        ...
        {
            ProfilingUtils.BeginSample("VFXController - SpawnFX");
        ...
        {
            ProfilingUtils.BeginSample("VFXController.Play");
            if (emitters[i].spawnOnPlay)
            {
                SpawnFX(i);
            }
        ...
        {
            ProfilingUtils.BeginSample("VFXController.Stop");
            if (emitters[i] != null && emitters[i].instanceGO != null)
            {
                if (emitters[i].fxPS != null && !emitters[i].lateTime)
                {
                    ProfilingUtils.BeginSample("VFXController.StopEmitter");
        ...
        public void StopAndDestroy(int i, float destroyInSeconds)
        {
            ...
            if (emitters[i] != null)
            {
                global::UnityEngine.Object.Destroy(emitters[i].instanceGO, destroyInSeconds);
            }
        }
