    ...
    public class VoidGhostLeviathansSpawner : MonoBehaviour
    {
        ...
        private void UpdateSpawn()
        {
            ...
            if ((bool)player)
            {
                ...
                {
                    GameObject item = global::UnityEngine.Object.Instantiate(ghostLeviathanPrefab, spawnPosition, Quaternion.identity);
        ...
        private bool TryGetSpawnPosition(Vector3 playerPosition, out Vector3 spawnPosition)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                spawnPosition = playerPosition + global::UnityEngine.Random.onUnitSphere * spawnDistance;
