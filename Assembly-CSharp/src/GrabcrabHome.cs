...
namespace AssemblyCSharp
{
    public class GrabcrabHome : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            int num = global::UWE.Utils.OverlapSphereIntoSharedBuffer(base.transform.position, kLootCheckRadius);
            for (int i = 0; i < num; i++)
            {
                Pickupable component = global::UWE.Utils.sharedColliderBuffer[i].gameObject.GetComponent<Pickupable>();
