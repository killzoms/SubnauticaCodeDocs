...
namespace AssemblyCSharp
{
    public class VFXSchoolFishManager : MonoBehaviour
    {
        ...
        {
            ProfilingUtils.BeginSample("VFXSchoolFishManager-UpdateSchoolData");
            try
            {
                int count = schools.Count;
                if (count == 0)
        ...
        {
            ProfilingUtils.BeginSample("VFXSchoolFishManager-UpdateSchoolParticles");
            ...
            for (int i = 0; i < schoolsTextures.Count; i++)
            {
                ...
                for (int j = num2; j < num3; j++)
                {
                    ...
                    if (vFXSchoolFish != null && vFXSchoolFish.meshRenderer.enabled)
                    {
