...
namespace AssemblyCSharp
{
    public class VehicleDockingBay : MonoBehaviour, IAnimParamReceiver
    {
        ...
        {
            Vehicle componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<Vehicle>(other.gameObject);
            if (!(componentInHierarchy == null) && !componentInHierarchy.docked && !componentInHierarchy.GetRecentlyUndocked() && !GetDockedVehicle() && (!GameModeUtils.RequiresPower() || IsPowered()) && !(interpolatingVehicle != null))
            {
        ...
        {
            Vehicle componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<Vehicle>(nearby.gameObject);
        ...
        {
            if (!(global::UWE.Utils.GetComponentInHierarchy<Vehicle>(nearby.gameObject) != null))
            {
                return;
            }
            nearbyVehicle = null;
