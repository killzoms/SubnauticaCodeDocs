    ...
    public class VFXSunbeam : MonoBehaviour
    {
        ...
        private void UpdateBeam()
        {
            if (beamInstance != null)
            {
                ...
                {
                    global::UnityEngine.Object.Destroy(beamInstance);
                }
            }
        }
        ...
        public void PlaySFX()
        {
            global::UnityEngine.Object.Instantiate(shootDownSFX, new Vector3(411f, 0f, 1213f), Quaternion.identity);
        }
        ...
        private void DestroyEffects()
        {
            ...
            {
                global::UnityEngine.Object.Destroy(warmupTransform.gameObject);
            }
            if (muzzleTransform != null)
            {
                global::UnityEngine.Object.Destroy(muzzleTransform.gameObject);
            }
            if (explosionTransform != null)
            {
                global::UnityEngine.Object.Destroy(explosionTransform.gameObject);
            }
            if (gunSpawnPoint != null)
            {
                global::UnityEngine.Object.Destroy(gunSpawnPoint.gameObject);
            }
            if (gunTarget != null)
            {
                global::UnityEngine.Object.Destroy(gunTarget.gameObject);
            }
            if (rectifiedTarget != null)
            {
                global::UnityEngine.Object.Destroy(rectifiedTarget.gameObject);
            }
            if (shipTransform != null)
            {
                global::UnityEngine.Object.Destroy(shipTransform.gameObject);
            }
            global::UnityEngine.Object.Destroy(beamInstance);
        ...
        {
            global::UnityEngine.Object.Instantiate(burningChunkPrefabs[global::UnityEngine.Random.Range(0, burningChunkPrefabs.Length)], gunTarget.transform.position + chunkSpawnRadius * global::UnityEngine.Random.insideUnitSphere, Quaternion.identity).GetComponent<ParticleSystem>().Play();
        }
        ...
        private void UpdateSequence()
        {
            ...
            if (shipTransform != null)
            {
                ...
                if (shipAnimeTime < 1f)
                {
                    ...
                    if (shipAnimeTime >= 1f)
                    {
                        global::UnityEngine.Object.Destroy(shipTransform.gameObject, 5f);
                    }
                }
            }
        ...
        private void Update()
        {
            ProfilingUtils.BeginSample("VFXSunbeam.Update()");
            if (isPlaying)
            {
                UpdateSequence();
        ...
        private void OnDestroy()
        {
            if (beamMats != null)
            {
                ...
                {
                    global::UnityEngine.Object.Destroy(beamMats[i]);
                }
            }
        }
    }
