...
namespace AssemblyCSharp
{
    public class ScannerTool : PlayerTool
    {
        ...
        public Text screenProgressValueText;
        ...
        private void OnHover()
        {
            ...
            else if (PDAScanner.CanScan() == PDAScanner.Result.Scan)
            {
                HandReticle main = HandReticle.main;
                if (stateCurrent != ScanState.SelfScan)
                {
                    main.SetInteractText(scanTarget.techType.AsString(), translate: true, HandReticle.Hand.Right);
                }
