    ...
    public class NitrogenLevel : MonoBehaviour
    {
        ...
        public void OnTookBreath(Player player)
        {
            if (nitrogenEnabled)
            {
                ...
                safeNitrogenDepth = global::UWE.Utils.Slerp(safeNitrogenDepth, depthOf, num * kBreathScalar);
            }
        }
        ...
        {
            return Ocean.main.GetDepthOf(Player.main.gameObject) < safeNitrogenDepth - kDepthInterval;
        }
        ...
        private void Update()
        {
            if (nitrogenEnabled)
            {
                ...
                if (depthOf < safeNitrogenDepth)
                {
                    ...
                    safeNitrogenDepth = global::UWE.Utils.Slerp(safeNitrogenDepth, depthOf, kDissipateScalar * num * Time.deltaTime);
                }
            }
        }
    }
