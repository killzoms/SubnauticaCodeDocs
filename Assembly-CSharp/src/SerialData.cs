...
namespace AssemblyCSharp
{
    ...
    {
        private static ArrayAllocator<byte>.IAlloc emptyData;

        public ArrayAllocator<byte>.IAlloc Data { get; private set; }
        ...
        public void Concatenate(ScratchMemoryStream stream)
        {
            ...
            {
                int length = stream.GetLength();
                ArrayAllocator<byte>.IAlloc alloc = CommonByteArrayAllocator.Allocate(length + Length);
