...
namespace AssemblyCSharp
{
    public class InfectConsoleCommand : MonoBehaviour
    {
        ...
        {
            int num = global::UWE.Utils.OverlapSphereIntoSharedBuffer(Player.main.transform.position, radius);
            for (int i = 0; i < num; i++)
            {
                InfectedMixin componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<InfectedMixin>(global::UWE.Utils.sharedColliderBuffer[i].gameObject);
