...
namespace AssemblyCSharp
{
    public class WeatherManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            PrefabSpawn component = base.gameObject.GetComponent<PrefabSpawn>();
        ...
        private void Update()
        {
            ProfilingUtils.BeginSample("WeatherManager.Update()");
            float num = global::UWE.Utils.StableNoise(Time.timeSinceLevelLoad * timeScalar * rainScalar / 1000000f);
            float num2 = global::UWE.Utils.StableNoise(Time.timeSinceLevelLoad * timeScalar * windScalar / 1000000f);
