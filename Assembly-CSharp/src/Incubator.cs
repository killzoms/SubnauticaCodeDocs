...
namespace AssemblyCSharp
{
    ...
    public class Incubator : MonoBehaviour, IHandTarget, ICompileTimeCheckable
    {
        ...
        private void Start()
        {
            ...
            {
                GameObject obj = global::UnityEngine.Object.Instantiate(eggPrefab, Vector3.zero, Quaternion.identity);
        ...
        public void OnHandHover(GUIHand hand)
        {
            if (terminalActive)
            {
                HandReticle.main.SetInteractText("Incubator", "Insert_Hatching_Enzymes");
        ...
        public void OnHatched()
        {
            ...
            {
                global::UnityEngine.Object.Destroy(enzymesObject);
            }
