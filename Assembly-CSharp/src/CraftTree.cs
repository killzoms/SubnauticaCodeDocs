...
namespace AssemblyCSharp
{
    public class CraftTree
    {
        ...
        {
            return new CraftNode("Root").AddNode(new CraftNode("BatteryMenu", TreeAction.Expand).AddNode(new CraftNode("LithiumIonBattery", TreeAction.Craft, TechType.LithiumIonBattery)), new CraftNode("KnifeMenu", TreeAction.Expand).AddNode(new CraftNode("HeatBlade", TreeAction.Craft, TechType.HeatBlade)), new CraftNode("TankMenu", TreeAction.Expand).AddNode(new CraftNode("PlasteelTank", TreeAction.Craft, TechType.PlasteelTank), new CraftNode("HighCapacityTank", TreeAction.Craft, TechType.HighCapacityTank)), new CraftNode("FinsMenu", TreeAction.Expand).AddNode(new CraftNode("UltraGlideFins", TreeAction.Craft, TechType.UltraGlideFins), new CraftNode("SwimChargeFins", TreeAction.Craft, TechType.SwimChargeFins)), new CraftNode("PropulsionCannonMenu", TreeAction.Expand).AddNode(new CraftNode("RepulsionCannon", TreeAction.Craft, TechType.RepulsionCannon)), new CraftNode("CyclopsMenu", TreeAction.Expand).AddNode(new CraftNode("CyclopsHullModule2", TreeAction.Craft, TechType.CyclopsHullModule2), new CraftNode("CyclopsHullModule3", TreeAction.Craft, TechType.CyclopsHullModule3)), new CraftNode("SeamothMenu", TreeAction.Expand).AddNode(new CraftNode("SeamothHullModule2", TreeAction.Craft, TechType.VehicleHullModule2), new CraftNode("SeamothHullModule3", TreeAction.Craft, TechType.VehicleHullModule3)), new CraftNode("ExosuitMenu", TreeAction.Expand).AddNode(new CraftNode("ExoHullModule2", TreeAction.Craft, TechType.ExoHullModule2)));
        }
        ...
        public static CraftTree GetTree(Type treeType)
        {
            ...
            {
                Type.Fabricator => fabricator, 
                Type.Constructor => constructor, 
                Type.Workbench => workbench, 
                Type.MapRoom => mapRoom, 
                Type.SeamothUpgrades => seamothUpgrades, 
                Type.Centrifuge => centrifuge, 
                Type.CyclopsFabricator => cyclopsFabricator, 
                _ => null, 
            };
        }
