    ...
    public class CyclopsHUDSonarPing : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (isCreaturePing)
            {
                ...
                LineRenderer[] array2 = componentsInChildren2;
                foreach (LineRenderer lineRenderer in array2)
                {
                    mats.Add(lineRenderer.material);
                }
        ...
        {
            if (colorChangeCD || mats.Count == 0 || currentColor == color)
            {
                return;
            }
