...
namespace AssemblyCSharp
{
    public class WarpBall : MonoBehaviour, IPropulsionCannonAmmo
    {
        ...
        private void WarpOut()
        {
            ...
            int num = global::UWE.Utils.OverlapSphereIntoSharedBuffer(base.transform.position, warpRadius);
            for (int i = 0; i < num; i++)
            {
        ...
        private void WarpIn()
        {
            ...
            WarperData.WarpInCreature randomCreature = warperData.GetRandomCreature(biomeName);
