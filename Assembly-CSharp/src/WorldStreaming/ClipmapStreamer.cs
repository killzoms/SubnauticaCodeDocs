...
namespace AssemblyCSharp.WorldStreaming
{
    ...
    {
        public readonly ClipMapManager.Settings settings;

        public readonly WorldStreamer host;

        public readonly IThread streamingThread;

        public readonly IThread buildLayersThread;

        public readonly IThread toggleChunksThread;

        public readonly IThread destroyChunksThread;

        public readonly global::UWE.ThreadPool meshingThreads;
        ...
        public ClipmapStreamer(WorldStreamer host, ClipmapVisibilityUpdater visibilityUpdater, IThread streamingThread, IThread buildLayersThread, IThread toggleChunksThread, IThread destroyChunksThread, ClipMapManager.Settings settings)
        {
            ...
            meshingThreads = new global::UWE.ThreadPool("MeshingThreads", settings.maxThreads, System.Threading.ThreadPriority.BelowNormal, settings.threadAffinityMask, 128);
        ...
        {
            return levels[0].IsRangeActiveAndBuilt(blockRange);
        }
        ...
        {
            streamingThread.Enqueue(BeginNotifyListeners, this, blockRange);
        }
