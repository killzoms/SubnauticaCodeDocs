...
namespace AssemblyCSharp.WorldStreaming
{
    ...
    {
        public readonly ClipMapManager.LevelSettings settings;

        public readonly ClipmapStreamer streamer;

        private readonly ClipmapVisibilityUpdater visibilityUpdater;
        ...
        public void BeginNotifyListeners(Int3.Bounds blockRange)
        {
            ...
            streamer.buildLayersThread.Enqueue(BeginNotifyCellLoaded, this, list);
        }
