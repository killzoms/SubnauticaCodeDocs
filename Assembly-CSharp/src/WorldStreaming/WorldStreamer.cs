...
namespace AssemblyCSharp.WorldStreaming
{
    public sealed class WorldStreamer : MonoBehaviour
    {
        ...
        [AssertNotNull]
        [SerializeField]
        public ClipmapChunk chunkPrefab;
        ...
        private IEnumerator ReloadSettingsAsync(ClipMapManager.IClipMapEventHandler clipmapListener)
        {
            ...
            streamingThread.Enqueue(InvokeUnload, this, clipmapStreamer);
            streamingThread.Enqueue(InvokeUnload, this, lowDetailOctreesStreamer);
            streamingThread.Enqueue(InvokeUnload, this, octreesStreamer);
