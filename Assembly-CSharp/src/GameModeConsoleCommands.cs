...
namespace AssemblyCSharp
{
    public class GameModeConsoleCommands : MonoBehaviour
    {
        ...
        {
            ErrorMessage.AddDebug("damage multiplier set to " + (DamageSystem.damageMultiplier = float.Parse((string)n.data[0])));
        }
        ...
        public void OnConsoleCommand_vranim(NotificationCenter.Notification n)
        {
            ...
            enableVrAnimations = (GameOptions.enableVrAnimations = ((n.data == null) ? (!enableVrAnimations) : bool.Parse((string)n.data[0])));
