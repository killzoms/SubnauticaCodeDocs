...
{
    [ProtoContract]
    public class BaseBioReactor : MonoBehaviour, IBaseModule, IProtoEventListener, IProtoTreeEventListener
    {
        ...
        public void OnHover()
        {
            ...
            main.SetInteractText(Language.main.GetFormat("UseBaseBioReactor", Mathf.RoundToInt(_powerSource.GetPower()), Mathf.RoundToInt(_powerSource.GetMaxPower())), "Tooltip_UseBaseBioReactor", translate1: false, translate2: true, addInstructions: true);
        ...
        public void OnProtoDeserialize(ProtobufSerializer serializer)
        {
            ...
            if (_protoVersion < 2)
            {
                ...
                {
                    StorageHelper.RestoreItems(serializer, _serializedStorage, container);
