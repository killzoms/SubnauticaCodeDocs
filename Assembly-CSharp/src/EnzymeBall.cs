...
namespace AssemblyCSharp
{
    public class EnzymeBall : MonoBehaviour, IStoryGoalListener, IAnimParamReceiver, ICompileTimeCheckable
    {
        ...
        {
            if (global::UWE.Utils.GetComponentInHierarchy<Creature>(col.gameObject) != null)
            {
                InfectedMixin componentInHierarchy = global::UWE.Utils.GetComponentInHierarchy<InfectedMixin>(col.gameObject);
        ...
        public void OnHandHover()
        {
            if (!playerCured)
            {
                ...
                HandReticle.main.SetInteractText("UseEnzymeCureBall");
            }
        }
        ...
        public void OnHandClick()
        {
            if (!playerCured)
            {
                ...
                leftGlove = global::UnityEngine.Object.Instantiate(leftGlovePrefab, Vector3.zero, Quaternion.identity);
                leftGlove.transform.SetParent(main.armsController.leftHand, worldPositionStays: false);
                rightGlove = global::UnityEngine.Object.Instantiate(rightGlovePrefab, Vector3.zero, Quaternion.identity);
        ...
        private void OnPlayerCinematicModeEnd(PlayerCinematicController cinematicController)
        {
            ...
            global::UnityEngine.Object.Destroy(leftGlove);
            global::UnityEngine.Object.Destroy(rightGlove);
        }
