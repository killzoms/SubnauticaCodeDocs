    ...
    public class VFXPool : MonoBehaviour
    {
        ...
        public static VFXPool main
        {
            get
            {
                if (_main == null)
                {
                    _main = global::UnityEngine.Object.FindObjectOfType<VFXPool>();
                }
                return _main;
            }
        }
        ...
        public void Warmup(FX fx)
        {
            ...
            {
                GameObject gameObject = global::UnityEngine.Object.Instantiate(fx.prefab, base.transform.position, Quaternion.identity);
