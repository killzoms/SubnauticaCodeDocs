...
namespace AssemblyCSharp
{
    ...
    public class Plantable : MonoBehaviour, IProtoEventListener, IShouldSerialize
    {
        ...
        {
            GameObject gameObject = global::UnityEngine.Object.Instantiate(model);
            ...
            if (isIndoor)
            {
                ...
                global::UnityEngine.Object.Destroy(gameObject.GetComponent<WorldForces>());
            }
            ...
            {
                global::UnityEngine.Object.Destroy(gameObject.GetComponent<Pickupable>());
                TechType techType = CraftData.GetTechType(gameObject);
                gameObject.AddComponent<TechTag>().type = techType;
                global::UnityEngine.Object.Destroy(gameObject.GetComponent<UniqueIdentifier>());
        ...
        public void SetMaxPlantHeight(float height)
        {
            if (growingPlant != null)
            {
                ...
                {
                    global::UnityEngine.Object.Destroy(linkedGrownPlant.gameObject);
