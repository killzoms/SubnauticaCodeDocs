...
namespace AssemblyCSharp
{
    public class SubNameInput : uGUI_InputGroup, IColorChangeHandler, IEventSystemHandler, uGUI_IButtonReceiver, IPointerHoverHandler
    {
        ...
        public Text uiInactiveText;

        public Text colorDisplayText;
        ...
        {
            base.Update();
            if (base.focused && player != null && (player.transform.position - base.rt.position).sqrMagnitude >= terminationSqrDistance)
            {
                Deselect();
            }
        }
        ...
        public void OnPointerHover(PointerEventData eventData)
        {
            ...
            {
                HandReticle.main.SetInteractText(hoverTextKey);
