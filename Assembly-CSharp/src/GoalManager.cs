...
namespace AssemblyCSharp
{
    public class GoalManager : MonoBehaviour
    {
        ...
        {
            ProfilingUtils.BeginSample("GoalManager.OnCustomGoalEvent." + customGoalText);
        ...
        {
            ProfilingUtils.BeginSample("GoalManager.ChooseNewGoal");
            int num = 0;
            for (int i = 0; i < goals.Count; i++)
            {
        ...
        {
            ProfilingUtils.BeginSample("GoalManager.UpdateFindGoal");
            for (int i = 0; i < goalObjects.Count; i++)
            {
                GoalObject goalObject = goalObjects[i];
