...
namespace AssemblyCSharp
{
    public class BatchCells
    {
        ...
        {
            cellsTier0 = new Array3<EntityCell>(global::UWE.Utils.CeilShiftRight(10, 0));
            cellsTier1 = new Array3<EntityCell>(global::UWE.Utils.CeilShiftRight(10, 1));
            cellsTier2 = new Array3<EntityCell>(global::UWE.Utils.CeilShiftRight(10, 1));
            cellsTier3 = new Array3<EntityCell>(global::UWE.Utils.CeilShiftRight(10, 1));
        }
        ...
        public EntityCell EnsureCell(Int3 cellId, int level)
        {
        ...
        public EntityCell Add(Int3 cellId, int level)
        {
            try
            {
        ...
        public EntityCell Get(Int3 cellId, int level)
        {
            try
            {
        ...
        public void QueueForAwake(Int3.Bounds bsRange, int level, IQueue<EntityCell> queue)
        {
            Int3 cellSize = GetCellSize(level, host.blocksPerBatch);
            Int3.Bounds coarseBounds = Int3.Bounds.OuterCoarserBounds(bsRange, cellSize);
            if (host.debugBatchCells)
            {
                Int3.Bounds.FinerBounds(coarseBounds, cellSize);
            }
        ...
        public void QueueForSleep(Int3.Bounds bsRange, int level, IQueue<EntityCell> queue)
        {
            Int3 cellSize = GetCellSize(level, host.blocksPerBatch);
            Int3.Bounds coarseBounds = Int3.Bounds.OuterCoarserBounds(bsRange, cellSize);
            if (host.debugBatchCells)
        ...
        {
            ProfilingUtils.BeginSample("BatchCells::EstimateBytes");
            int num = 8;
            num += 4;
            num += 4;
            num += 12;
