...
namespace AssemblyCSharp
{
    ...
    public class CuteFishHandTarget : CinematicModeTriggerBase
    {
        ...
        public override void OnHandHover(GUIHand hand)
        {
            ...
            if (!cuteFish.goodbyePlayed && Player.main.GetRightHandDown() && state == State.None)
            {
            ...
            HandReticle.main.SetInteractText("PlayWithFish", text, translate1: true, translate2: false, addInstructions: true);
        ...
        private void PrepareCinematicMode(Player setPlayer, CuteFishCinematic cinematic)
        {
            ...
            creatureRigidbody.isKinematic = true;
            ...
            if (state == State.Rotate)
            {
                ...
                else
                {
                    ...
                    if (num == 1f)
                    {
                        ...
                        {
                            tempCinematicItem = global::UnityEngine.Object.Instantiate(currentCinematic.itemPrefab, Vector3.zero, Quaternion.identity);
        ...
        private void StopPlaying()
        {
            ...
            global::UnityEngine.Object.Destroy(tempCinematicItem);
            state = State.None;
            player = null;
            creatureRigidbody.isKinematic = false;
        }
