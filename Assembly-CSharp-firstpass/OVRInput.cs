...
public static class OVRInput
{
    ...
    public static bool GetControllerOrientationTracked(Controller controllerType)
    {
        ...
        {
            Controller.LTouch => OVRPlugin.GetNodeOrientationTracked(OVRPlugin.Node.HandLeft), 
            Controller.RTouch => OVRPlugin.GetNodeOrientationTracked(OVRPlugin.Node.HandRight), 
            _ => false, 
        };
    }
    ...
    public static bool GetControllerPositionTracked(Controller controllerType)
    {
        return controllerType switch
        {
            Controller.LTouch => OVRPlugin.GetNodePositionTracked(OVRPlugin.Node.HandLeft), 
            Controller.RTouch => OVRPlugin.GetNodePositionTracked(OVRPlugin.Node.HandRight), 
            _ => false, 
        };
    }
    ...
    public static Vector3 GetLocalControllerPosition(Controller controllerType)
    {
        return controllerType switch
        {
            Controller.LTouch => OVRPlugin.GetNodePose(OVRPlugin.Node.HandLeft, useFixedPoses).ToOVRPose().position, 
            Controller.RTouch => OVRPlugin.GetNodePose(OVRPlugin.Node.HandRight, useFixedPoses).ToOVRPose().position, 
            _ => Vector3.zero, 
        };
    }
    ...
    public static Vector3 GetLocalControllerVelocity(Controller controllerType)
    {
        return controllerType switch
        {
            Controller.LTouch => OVRPlugin.GetNodeVelocity(OVRPlugin.Node.HandLeft, useFixedPoses).ToOVRPose().position, 
            Controller.RTouch => OVRPlugin.GetNodeVelocity(OVRPlugin.Node.HandRight, useFixedPoses).ToOVRPose().position, 
            _ => Vector3.zero, 
        };
    }
    ...
    public static Vector3 GetLocalControllerAcceleration(Controller controllerType)
    {
        return controllerType switch
        {
            Controller.LTouch => OVRPlugin.GetNodeAcceleration(OVRPlugin.Node.HandLeft, useFixedPoses).ToOVRPose().position, 
            Controller.RTouch => OVRPlugin.GetNodeAcceleration(OVRPlugin.Node.HandRight, useFixedPoses).ToOVRPose().position, 
            _ => Vector3.zero, 
        };
    }
    ...
    public static Quaternion GetLocalControllerRotation(Controller controllerType)
    {
        return controllerType switch
        {
            Controller.LTouch => OVRPlugin.GetNodePose(OVRPlugin.Node.HandLeft, useFixedPoses).ToOVRPose().orientation, 
            Controller.RTouch => OVRPlugin.GetNodePose(OVRPlugin.Node.HandRight, useFixedPoses).ToOVRPose().orientation, 
