...
public class ShaderPropertyID
{
    ...
    public static readonly int _PatchLength = Shader.PropertyToID("_PatchLength");
    ...
    public static readonly int _DisplacementMap = Shader.PropertyToID("_DisplacementMap");
    ...
    public static readonly int _OneTexel = Shader.PropertyToID("_OneTexel");
