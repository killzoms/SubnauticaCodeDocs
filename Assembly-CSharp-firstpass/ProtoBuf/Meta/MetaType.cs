...
namespace ProtoBuf.Meta
{
    public class MetaType : ISerializerProxy
    {
                ...
                if (serializer == null)
                {
                    ...
                    try
                    {
                        ...
                        if (serializer == null)
                        {
                            ...
                            ProfilingUtils.BeginSample("BuildSerializer");
        ...
        private IProtoTypeSerializer BuildSerializer()
        {
            if (Helpers.IsEnum(type))
            {
                ProfilingUtils.BeginSample("new TagDecorator");
                TagDecorator result = new TagDecorator(1, WireType.Variant, strict: false, new EnumSerializer(type, GetEnumMap()));
                ProfilingUtils.EndSample();
                return result;
            }
            ...
            if (itemType != null)
            {
                ...
                ProfilingUtils.BeginSample("new ValueMember");
                ValueMember valueMember = new ValueMember(model, 1, type, itemType, defaultType, DataFormat.Default);
                ProfilingUtils.EndSample();
                ProfilingUtils.BeginSample("new TypeSerializer+IProtoSerializer");
                TypeSerializer result2 = new TypeSerializer(model, type, new int[1] { 1 }, new IProtoSerializer[1] { valueMember.Serializer }, null, isRootType: true, useConstructor: true, null, constructType, factory);
                ProfilingUtils.EndSample();
                return result2;
            }
            if (surrogate != null)
            {
                ProfilingUtils.BeginSample("new SurrogateSerializer");
                ...
                SurrogateSerializer result3 = new SurrogateSerializer(model, type, surrogate, metaType.Serializer);
                ProfilingUtils.EndSample();
                return result3;
            }
            if (IsAutoTuple)
            {
                ProfilingUtils.BeginSample("new TupleSerializer");
                ...
                TupleSerializer result4 = new TupleSerializer(model, constructorInfo, mappedMembers);
                ProfilingUtils.EndSample();
                return result4;
            }
            ProfilingUtils.BeginSample("new IProtoSerializer");
            fields.Trim();
            ...
            ProfilingUtils.EndSample();
            int num2 = 0;
            ProfilingUtils.BeginSample("BuildSerializer Subtypes");
            if (num != 0)
            {
            ...
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("BuildSerializer Fields");
            if (count != 0)
            {
                BasicList.NodeEnumerator enumerator = fields.GetEnumerator();
                while (enumerator.MoveNext())
            ...
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("BuildSerializer Misc2");
            ...
            for (MetaType metaType3 = BaseType; metaType3 != null; metaType3 = metaType3.BaseType)
            {
                ...
                if (methodInfo != null)
                {
                    if (basicList == null)
                    {
                        ProfilingUtils.BeginSample("New BasicList");
            ...
            if (basicList != null)
            {
                ProfilingUtils.BeginSample("New MethodInfo");
                array3 = new MethodInfo[basicList.Count];
                ProfilingUtils.EndSample();
                ProfilingUtils.BeginSample("CopyTo");
                basicList.CopyTo(array3, 0);
                ProfilingUtils.EndSample();
                ProfilingUtils.BeginSample("Array.Reverse");
                Array.Reverse((Array)array3);
                ProfilingUtils.EndSample();
            }
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("new TypeSerializer");
            TypeSerializer result5 = new TypeSerializer(model, type, array, array2, array3, baseType == null, UseConstructor, callbacks, constructType, factory);
            ProfilingUtils.EndSample();
            return result5;
        }
