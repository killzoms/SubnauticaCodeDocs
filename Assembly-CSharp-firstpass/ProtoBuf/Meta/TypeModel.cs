    ...
    public abstract class TypeModel
    {
        ...
        internal bool TrySerializeAuxiliaryType(ProtoWriter writer, Type type, DataFormat format, int tag, object value, bool isInsideList)
        {
            ...
            case ProtoTypeCode.Decimal:
                ...
                return true;
            case ProtoTypeCode.String:
                ProfilingUtils.BeginSample("ProtoWriter.WriteString");
        ...
        private object DeserializeWithLengthPrefix(Stream source, object value, Type type, PrefixStyle style, int expectedField, Serializer.TypeResolver resolver, out long bytesRead, out bool haveObject, SerializationContext context)
        {
            ...
            do
            {
                ...
                ProfilingUtils.BeginSample("ProtoReader.ReadLongLengthPrefix");
            ...
            try
            {
                ProfilingUtils.BeginSample("ProtoReader.Create");
                protoReader = ProtoReader.Create(source, this, context, num);
                ProfilingUtils.EndSample();
                int key = GetKey(ref type);
                if (key >= 0 && !Helpers.IsEnum(type))
                {
                    ProfilingUtils.BeginSample("TypeModel.Deserialize");
            ...
            {
                ProfilingUtils.BeginSample("ProtoReader.Recycle");
        ...
        public void SerializeWithLengthPrefix(Stream dest, object value, Type type, PrefixStyle style, int fieldNumber, SerializationContext context)
        {
            ...
            int key = GetKey(ref type);
            ProfilingUtils.BeginSample("New ProtoWriter");
            ...
            case PrefixStyle.None:
                ProfilingUtils.BeginSample("TypeModel.Serialize");
            ...
            case PrefixStyle.Fixed32BigEndian:
                ProfilingUtils.BeginSample("TypeModel.ProtoWriter.WriteObject");
            ...
            ProfilingUtils.BeginSample("WriterClose");
            protoWriter.Close();
