...
namespace ProtoBuf.Meta
{
    public sealed class RuntimeTypeModel : TypeModel
    {
        ...
        {
            ProfilingUtils.BeginSample("RuntimeTypeModel.CastToMetaType");
            MetaType obj = (MetaType)types[key];
            ProfilingUtils.EndSample();
            ProfilingUtils.BeginSample("RuntimeTypeModel.WriteToSerializer");
            obj.Serializer.Write(value, dest);
            ProfilingUtils.EndSample();
        }
