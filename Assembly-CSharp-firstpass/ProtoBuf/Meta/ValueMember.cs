    ...
    public class ValueMember
    {
        ...
        internal IProtoSerializer Serializer
        {
            get
            {
                if (serializer == null)
                {
                    ProfilingUtils.BeginSample("ValueMember.BuildSerializer");
        ...
        private IProtoSerializer BuildSerializer()
        {
            ...
            try
            {
                ...
                ProfilingUtils.BeginSample("TryGetCoreSerializer");
                ...
                if (itemType != null && SupportNull)
                {
                    ...
                    ProfilingUtils.BeginSample("new TagNullTagDecorators");
                ...
                if (itemType != null)
                {
                    ...
                    {
                        ProfilingUtils.BeginSample("new ArrayDecorator");
                        protoSerializer = new ArrayDecorator(model, protoSerializer, fieldNumber, IsPacked, defaultWireType, memberType, OverwriteList, SupportNull);
                        ProfilingUtils.EndSample();
                    }
                    else
                    {
                        ProfilingUtils.BeginSample("ListDecorator.Create");
                        protoSerializer = ListDecorator.Create(model, memberType, defaultType, protoSerializer, fieldNumber, IsPacked, defaultWireType, member != null && PropertyDecorator.CanWrite(model, member), OverwriteList, SupportNull);
                        ProfilingUtils.EndSample();
                    }
                }
                else if (defaultValue != null && !IsRequired && getSpecified == null)
                {
                    ProfilingUtils.BeginSample("new DefaultValueDecorator");
                    protoSerializer = new DefaultValueDecorator(model, defaultValue, protoSerializer);
                    ProfilingUtils.EndSample();
                }
                if (memberType == model.MapType(typeof(Uri)))
                {
                    ProfilingUtils.BeginSample("new UriDecorator");
                ...
                if (member != null)
                {
                    ...
                    {
                        ProfilingUtils.BeginSample("new PropertyDecorator");
                    ...
                    else
                    {
                        ...
                        ProfilingUtils.BeginSample("new FieldDecorator");
                        protoSerializer = new FieldDecorator(parentType, (FieldInfo)member, protoSerializer);
                        ProfilingUtils.EndSample();
                    }
                    if (getSpecified != null || setSpecified != null)
                    {
                        ProfilingUtils.BeginSample("new MemberSpecifiedDecorator");
