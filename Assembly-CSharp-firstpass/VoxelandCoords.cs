...
public class VoxelandCoords
{
    ...
    public VoxelandCoords GetOpposite()
    {
        return dir switch
        {
            0 => new VoxelandCoords(x, y + 1, z, 1), 
            1 => new VoxelandCoords(x, y - 1, z, 0), 
            2 => new VoxelandCoords(x + 1, y, z, 3), 
            3 => new VoxelandCoords(x - 1, y, z, 2), 
            4 => new VoxelandCoords(x, y, z - 1, 5), 
            5 => new VoxelandCoords(x, y, z + 1, 4), 
            _ => new VoxelandCoords(x, y, z, 0), 
        };
    }
