...
public class StopwatchRecorder
{
    ...
    public string GetMetaSummaryCSV(ABTestVariant variant)
    {
        ...
        {
            ABTestVariant.NOT_TESTING => $"Average,{watchID},{metaRecordA.avgTotalFrameTime},{metaRecordA.avgTotalFrameCount},{metaRecordA.avgAvgFrameTime},{metaRecordA.avgAvgFrameRateOrMaxFrameTime},{metaRecordA.avgTotalBytesAllocated / 1024f}", 
            ABTestVariant.A => $"Test A,{watchID},{metaRecordA.avgTotalFrameTime},{metaRecordA.avgTotalFrameCount},{metaRecordA.avgAvgFrameTime},{metaRecordA.avgAvgFrameRateOrMaxFrameTime},{metaRecordA.avgTotalBytesAllocated / 1024f}", 
            _ => $"Test B,{watchID},{metaRecordB.avgTotalFrameTime},{metaRecordB.avgTotalFrameCount},{metaRecordB.avgAvgFrameTime},{metaRecordB.avgAvgFrameRateOrMaxFrameTime},{metaRecordB.avgTotalBytesAllocated / 1024f}", 
        };
    }
